...
<?php
$message_list="";
$sql=mysql_query("SELECT*FROM mail WHERE username='$employee'");
...
if ($mail_count > 0) {
  while($row = mysql_fetch_array($sql)){ 
   ...
   $message_list .= "<h4>Message From:</h4> $username </br> <h4>Time Sent:</h4> <em>$date_added</em> <br/> <h4>Message:</h4> $message </br> <a href='#delete_message' data-rel='popup' data-position-to='window' data-transition='fade' class='ui-btn ui-corner-all ui-shadow ui-btn-inline'>Delete?</a>
   <div data-role='popup' id='delete_message'>
   <h5>Are you sure?</h5>
   <a href='messages_r.php?deleteMessage=$id' class='ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b ui-icon-check ui-btn-icon-left'>Yes</a>
