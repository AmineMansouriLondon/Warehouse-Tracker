...
<?php
$message_list="";
$sql=mysql_query("SELECT*FROM mail_to_employer WHERE from_username='$employee' ORDER BY date_added DESC");
...
if ($mail_count > 0) {
  while($row = mysql_fetch_array($sql)){ 
   ...
   <h4>Message To: $username </h4> <h4>Time Sent:</h4> <em>$date_added</em> <br/> <p>Message:</p> $message </br> <a href='#delete_message' data-rel='popup' data-position-to='window' data-transition='fade' class='ui-btn ui-corner-all ui-shadow ui-btn-inline'>Delete?</a>
