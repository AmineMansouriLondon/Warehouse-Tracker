...
<?php
$message_list="";
$sql=mysql_query("SELECT*FROM mail_to_manager WHERE username='$manager' ORDER BY date_added DESC");
...
if ($mail_count > 0) {
  while($row = mysql_fetch_array($sql)){ 
   ...
   <h4>Message From: $username_f </h4></br> <h4>Time Sent:</h4> <em>$date_added</em> <br/> <h4>Message:</h4> $message </br> <a href='#delete_message' data-rel='popup' data-position-to='window' data-transition='fade' class='ui-btn ui-corner-all ui-shadow ui-btn-inline'>Delete?</a>
