...
<body>
  ...
  <center><h3 style="color:blue;">MANAGER<h3><h1>WAREHOUSE <div style="color:red;">TRACKER <img src="assets/images/warehouse.png"></div><h1></center>
</br>
...
<div data-role="main" class="ui-content">
  ...
  <br>
  <a data-role="button" data-transition="slidefade" href="pages/position.php" class="ui-btn ui-icon-location ui-btn-icon-left">Management Position</a>
  <br>
  <a data-role="button" data-transition="slidefade" href="pages/messages_r.php" class="ui-btn ui-icon-mail ui-btn-icon-left">Messages</a>
  <br>
  <a data-role="button" data-transition="slidefade" href="pages/manage.php" class="ui-btn ui-icon-gear ui-btn-icon-left">Manage</a>
  <br>
</div>
